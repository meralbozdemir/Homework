...
//		driver.findElement(By.xpath("//*[@id=\"layer_cart\"]/div[1]/div[2]/div[4]/span")).click(); // continue Shopping
		...
		driver.findElement(By.id("email")).sendKeys("test@testuser.com");
		Thread.sleep(2000);
...
//		driver.findElement(By.className("bankwire")).click(); //Banka havalesi ile odemek icin
//		Thread.sleep(3000);
		
		driver.findElement(By.className("cheque")).click();//Cek ile odemek icin, yalnizca biri secilebilir.
		Thread.sleep(5000);
		...
		System.out.println(pageText);//ve consola yazdir yada bunu comment out yap ve yazdirma.
